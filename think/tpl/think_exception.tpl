...
<body>
    ...
    <div class="copyright">
        <a title="官方网站" href="https://www.workerman.net/webman">Webman</a> 
        <span>{ 高性能可扩展PHP框架-以最小内核提供最大的扩展性与最强的性能 }</span>
        <span>- <a title="官方手册" href="https://www.workerman.net/doc/webman/">官方手册</a></span>
    </div>
    <?php if (config('app.debug', true)) { ?>
    <script>
